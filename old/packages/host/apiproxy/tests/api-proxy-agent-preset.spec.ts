  ...
  return {
    ...
    acquireStandingKey: async (id?: string) => {
      ...
      return {
        key,
        release: () => {
          standingKeyReleases.push(wanted)
          return Promise.resolve()
        },
      }
    },
...
const standingKeyReleases: string[] = []
