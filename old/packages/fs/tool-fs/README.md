...
| `readMaxLineLength` | `2000` | UTF-16 code units kept per line before truncation (the suffix names the cap); a boundary inside a surrogate pair backs up one unit. |
