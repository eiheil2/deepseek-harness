...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'async acquireStandingKey(id?: string): Promise<StandingKeyLease>',
        description: 'Acquire a standing key for one bounded host read.\n\nThe lease prevents a concurrently superseded generation from being disposed until the read completes. Callers must release it in `finally`.',
        parameters: [{ name: 'id', description: 'the preset id, or `undefined` for {@link defaultId}.' }],
...
export const TYPE_API: readonly TypeApiEntry[] = [
  ...
  {
    name: 'StandingKeyLease',
    declaration: 'export interface StandingKeyLease {\n    readonly key: ScopeKey;\n    release(): Promise<void>;\n}',
  },
  {
    name: 'StorageBackend',
