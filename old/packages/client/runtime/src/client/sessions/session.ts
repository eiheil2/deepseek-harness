...
export class Session implements SessionFace {
  ...
  async loadOlder(): Promise<void> {
    ...
    try {
      ...
      // oxlint-disable-next-line typescript/no-unnecessary-condition -- gap repair can replace baseSeq during the await.
      if (generation !== this.openGeneration || this.openState !== 'open' || beforeSeq !== this.baseSeq) return
