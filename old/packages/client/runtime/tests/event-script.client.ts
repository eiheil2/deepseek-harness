...
export const ev = {
  ...
  codeDispatchStart: (
    ...
    name: string,
    args: unknown,
    executionNamespace = 'test-exec',
  ): SessionEvent =>
    at(seq, {
      type: 'tool/code-dispatch-start',
      data: {
        rootCallId: parentCallId, parentCallId,
        subCallId: `${parentCallId}:code:${executionNamespace}:${n}`,
        name, arguments: args,
      },
    }),
  codeDispatch: (
    ...
    at(seq, {
      ...
      data: {
        rootCallId: parentCallId, parentCallId,
        subCallId: `${parentCallId}:code:${executionNamespace}:${n}`,
        name, arguments: args, isError, content: text(body),
      },
    }),
