 ...
 */
export function cacheHitPercent(usage: CacheTelemetryProjection): number | null {
  const denominator = usage.reportedInputTokens + usage.cacheReadTokens + usage.cacheWriteTokens
...
export function contextOccupancy(
  ...
  return {
    ...
    ...pressure.contextEstimated === undefined ? {} : { contextEstimated: pressure.contextEstimated },
  }
}
...
export const StatsLine = memo(function StatsLine({ useSession, useProjection, t }: StatsLineProps) {
  ...
  const cacheTelemetry = useProjection('cacheTelemetry')
  ...
  if (usage !== undefined
    ...
    const cacheHit = cacheTelemetry === undefined ? null : cacheHitPercent(cacheTelemetry)
