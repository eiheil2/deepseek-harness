...
describe('StatsLine', () => {
  ...
  function props(
    ...
    values: Record<string, unknown> = {
      tokenUsage: USAGE,
      cacheTelemetry: { reportedInputTokens: 10, cacheReadTokens: 90, cacheWriteTokens: 0 },
    },
  ): StatsLineProps {
  ...
  it('renders the grouped stats row and hides a brand-new empty session', () => {
    ...
    const emptyView = render(<StatsLine {...props(empty.source, {
      ...
      cacheTelemetry: { reportedInputTokens: 0, cacheReadTokens: 0, cacheWriteTokens: 0 },
      contextPressure: {},
    })} />)
  ...
  it('includes cache writes in billed input and the cache-hit denominator', () => {
    ...
    const view = render(<StatsLine {...props(source, {
      ...
      cacheTelemetry: { reportedInputTokens: 10, cacheReadTokens: 90, cacheWriteTokens: 100 },
    })} />)
    expect(view.container.textContent)
