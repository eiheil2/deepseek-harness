...
| `fetchTimeoutMs` | `30000` | Positive cooperative tool-call timeout budget (ms) for `web_fetch`, no greater than [`MAX_TIMER_DELAY_MS`](../../util/timeout/README.md). |
| `searchTimeoutMs` | `30000` | Positive cooperative tool-call timeout budget (ms) for `web_search`, no greater than [`MAX_TIMER_DELAY_MS`](../../util/timeout/README.md). |
