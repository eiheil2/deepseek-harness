...
/**
 * Map pi-ai usage (reasoning is a reported subset of output).
 * @param usage - cumulative usage from the terminal pi-ai event.
 * @returns harness counts; cache fields appear only when non-zero, while an
 *   explicitly reported reasoning breakdown appears even when zero.
 */
