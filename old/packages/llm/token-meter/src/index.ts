...
import { cacheTelemetryProjectionDefinition, contextPressureProjectionDefinition, tokenUsageProjectionDefinition } from './usage-projection.ts'
...
export class TokenMeter extends Service {
  ...
  constructor(ctx: Context, config: TokenMeterConfig = {}) {
    ...
    ctx.inject(['sessionProjections'], (projectionCtx) => {
      ...
      projectionCtx.sessionProjections.register(cacheTelemetryProjectionDefinition)
