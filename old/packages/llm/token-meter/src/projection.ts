...
/** Cumulative cache telemetry, restricted to provider samples that reported cache fields. */
...
export interface ContextPressureProjection {
  ...
  /** Whether the newest capacity is an adapter fallback estimate. */
...
declare module '@deepseek-ai/dsh-session-projection/types' {
  interface SessionProjectionMap {
    ...
    /** Cache totals and denominator from samples that actually reported cache fields. */
    cacheTelemetry: CacheTelemetryProjection
