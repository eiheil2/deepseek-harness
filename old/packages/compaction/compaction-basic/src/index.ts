...
const retainTokensSchema = z.number().step(1).min(0).max(Number.MAX_SAFE_INTEGER)
const summarizationProviderSchema = z.string()
const summarizationModelSchema = z.string()
const maxTokensSchema = z.number().step(1).min(1).max(Number.MAX_SAFE_INTEGER)
const compactionRetriesSchema = z.number().step(1).min(0).max(Number.MAX_SAFE_INTEGER)
const maxOverflowRetriesSchema = z.number().step(1).min(0).max(Number.MAX_SAFE_INTEGER)
