...
| `fetchTimeoutMs` | `120000` | Cooperative tool-call timeout budget (ms) for `web_fetch`. |
| `searchTimeoutMs` | `120000` | Cooperative tool-call timeout budget (ms) for `web_search`. |
