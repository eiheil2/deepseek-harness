...
export const en = {
  ...
  modelInput: 'Accepted input',
  modelInputInherit: 'Auto (installed catalog)',
  modelInputText: 'Text only',
  modelInputVision: 'Text and images',
  modelReasoning: 'Reasoning control',
  modelReasoningInherit: 'Auto (installed catalog)',
  modelReasoningDisabled: 'Not supported',
  modelReasoningStandard: 'Low / medium / high',
  modelReasoningExtended: 'All levels, including max',
  modelReasoningOpenRouter: 'OpenRouter effort object',
  modelReasoningBinary: 'On / off only',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelInput: '可接受输入',
  modelInputInherit: '自动（内置目录）',
  modelInputText: '仅文本',
  modelInputVision: '文本和图片',
  modelReasoning: '推理强度控制',
  modelReasoningInherit: '自动（内置目录）',
  modelReasoningDisabled: '不支持',
  modelReasoningStandard: '低 / 中 / 高',
  modelReasoningExtended: '全部等级（含 max）',
  modelReasoningOpenRouter: 'OpenRouter 强度对象',
  modelReasoningBinary: '仅开 / 关',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
